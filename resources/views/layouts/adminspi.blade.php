            ...
            <ul class="list-unstyled">
              ...
              <li>
                <a
                  ...
                  >Menu LHA</a>
                  <ul class="collapse list-unstyled" id="menuLHA">
                    <li>
                      <a href="{{ route('adminspi.lha.index') }}" class="list-group-item list-group-item-action ">Upload LHA</a>
                    </li>
                    <li>
                      <a href="{{ route('adminspi.add.temuan') }}" class="list-group-item list-group-item-action" >Input Data Tindak Lanjut</a>
                    </li>
                    <li>
                      <a href="{{ route('adminspi.assign.index') }}" class="list-group-item list-group-item-action ">Assign Data Ke Departemen</a>
                    </li>
                  </ul>
              </li>
              <li>
              ...
              <li>
                <a
                  href="{{ route('adminspi.report.index') }}"
                  class="list-group-item list-group-item-action "
                  >Report</a
                >
              </li>
              ...
              <ul class="navbar-nav d-block d-lg-none mt-3">
                <li class="nav-item">
                  <a class="nav-link" href="#">
                    Hi,
                    <img
                      src="./sitinjut/images/icon-user.png"
                      alt=""
                      class="rounded-circle mr-2 profile-picture"
                    />
                  </a>  
